# ============================================================================
# Unit tests for cacs_plot_site_rates() (Stage 4).
#
# 5 testcases:
...
#
# Uses bundled fixtures + a small cacs_run() invocation (one site, one
# drive time). Falls back to a hand-constructed run_result tibble for
