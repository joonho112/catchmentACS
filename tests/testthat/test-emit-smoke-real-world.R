# ============================================================================
# Env-gated live smoke for condition capture.
# ============================================================================
...
test_that("P5-SMOKE-01 live water-tract condition capture smoke is gated", {
  ...
  if (!identical(Sys.getenv("CATCHMENTACS_LIVE_SMOKE"), "true")) {
    testthat::skip("Set CATCHMENTACS_LIVE_SMOKE=true to run live smoke tests.")
  }
  if (!nzchar(Sys.getenv("CENSUS_API_KEY"))) {
    testthat::skip("CENSUS_API_KEY required for live smoke tests.")
  }
