...
#
# Layer 0 unit tests for the 4 v0.4 package options
# registered in R/zzz.R `.onLoad()` and documented in R/aaa-globals.R.
#
# Coverage:
#   - 4 tests: default values match the documented defaults.
...
test_that("LAYER0-OPT-04 catchmentACS.rate_first_default default = FALSE", {
  expect_false(
