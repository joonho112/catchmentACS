# ============================================================================
# Unit tests for R/isochrone-dispatch.R — argument validation surface.
...
.mk_iso_stub_sf <- function(site_id = "S01", drive_time_min = 5L,
  ...
  # 16-col canonical schema — matches what the provider backends
  # produce, so `.normalize_iso_schema()` accepts the stub.
  sf::st_sf(
    tibble::tibble(
      site_id                          = site_id,
