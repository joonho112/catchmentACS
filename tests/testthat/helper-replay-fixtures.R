...
# Replay fixtures installed with every build of the package.
shipped_replay_fixture_names <- function() {
  c("032_3site_fresh", "cache_poison", "annulus_input")
}

# All replay fixtures the tests can use. A fixture outside
# shipped_replay_fixture_names() is read when it is present and skipped otherwise.
replay_fixture_names <- function() {
  c("031_3site_anchors", shipped_replay_fixture_names())
}
