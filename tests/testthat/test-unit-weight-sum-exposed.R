# ============================================================================
# Unit tests for v0.2: lock `weight_sum` as a first-class column in
# the canonical long output (it was already exposed in v0.1; this
# regression test makes that exposure part of the v0.2.0 contract).
#
# Why we test even though v0.1 already exposes it:
#   - Exposure alone is not the same as a public lock. The v0.2.0
...
#
# Assertions:
#   1. `weight_sum` is a column in the long output of the full
...
#      via the `min(num_ws, den_ws)` convention.
# ============================================================================
...
# ---- T-WS-04: rate-row weight_sum = min(num_ws, den_ws) --------------------
