# ============================================================================
# Unit tests for the v0.2 n_tracts_num + n_tracts_den columns on derived rate
# rows (the v0.2 bivariate schema).
#
...
#
# Fixture builder mirrors the end-to-end cacs_intersect_weight() →
# cacs_propagate_moe() → cacs_derive_rates() chain used by
