# ============================================================================
# Integration tests for R/acs-prefetch.R: suppression carry-through,
# 17-field provenance attribute, .rds + optional .gpkg persist.
#
# 5 cases (T20-09..T20-13):
#   T20-09  survey acs1 deferred (re-checks the T20-04 schema abort)
...
#   T20-13  provenance attribute present with the 17 expected fields
#
...
# ===========================================================================
# T20-09  survey = 'acs1' aborts (re-checks the T20-04 schema abort)
# ===========================================================================
  ...
  .with_acs_cache_dir({
    .with_fake_census_key_int({
      ...
      expect_warning(
        ...
        class  = "catchmentACS_warning_runtime",
        regexp = "in place of a margin of error"
      )
      prov <- attr(out, "cacs_provenance")
      expect_identical(prov$n_suppressed, prov$n_estimate_suppressed)
...
# ===========================================================================
# T20-13  17-field provenance attribute present + field names match
# ===========================================================================
...
test_that("T20-13 provenance attribute is present with the §20.5 17 fields", {
  .with_acs_cache_dir({
    .with_fake_census_key_int({
      ...
      # The implemented field set (18 named fields):
      ...
      # The "17 fields" of the test name count variable_source under
      # variables; the implemented list has 18 distinct keys.
      expected_fields <- c(
