# ============================================================================
# Unit tests for the dispatch + carrier-lookup helpers in
# R/moe-helpers.R. 8 cases (T-DISP-01..08) covering:
#   - .dispatch_formula_auto() family -> formula mapping
#   - .dispatch_formula_list() per-variable override + auto-dispatch baseline
#   - .check_family_formula_consistency() matrix validation
#   - .lookup_carrier_num() C1/C2 fallback building block
# ============================================================================
...
test_that("T-DISP-03 .dispatch_formula_list overlays named entry onto auto baseline", {
  ...
  # derived_rate row keeps the C2 default.
...
test_that("T-DISP-08 .lookup_carrier_num returns NA when carrier missing the variable", {
  ...
  # NOT abort — cacs_derive_rates() turns the NA into failure_origin="carrier".
