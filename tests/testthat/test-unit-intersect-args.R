# ============================================================================
# Unit tests for R/intersect-weight.R - pre-loop validation surface.
# 11 cases (T21-01..T21-08 + T21-19 + 2 defensive edge cases).
#
# v0.2 (BUG-001) note: the degenerate-tract abort previously
...
# T21-06 weight_method='population' fail-loud
#
...
test_that("T21-19b Florida Keys (lat ~24.55) passes CONUS+DC guard", {
  ...
  # The full call runs: CONUS guard passes -> per-site loop
...
test_that("T21-EC1 sf_use_s2 is restored after a full successful call", {
  ...
  withr::local_options(catchmentACS.cache_intersect = FALSE)
  # The call runs to the end and returns instead of aborting.
