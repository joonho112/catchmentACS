# ============================================================================
# Unit tests for the v0.2 verbose progress reporter (hybrid bar/line mode).
#
# 10 testcases:
...
# isolation (no global state leak).
# ============================================================================
...
#
# All 3 functions should emit >= n_sites tick events at verbose=TRUE+bar
# mode; we cover cacs_isochrone and cacs_intersect_weight here.
# cacs_acs_prefetch is bookend-only (N = 1, degrades to no per-event tick)
# so it's covered by Case 2 (bookend) + Case 7 (force).
# ============================================================================
