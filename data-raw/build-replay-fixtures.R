# data-raw/build-replay-fixtures.R - writes the fixtures in inst/testdata/ that
# let tests replay two earlier runs without a network.
#
# It reads saved outputs of those runs from replay-sources/031/ and
# replay-sources/032/, which are not part of the package, keeps the small parts
# the tests need, and records where each fixture came from in a
# `cacs_provenance` attribute.
#
